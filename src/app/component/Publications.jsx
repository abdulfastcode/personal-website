...
const Publications = () => {
  ...
  return (
    <>
      <h1
        className="text-white text-5xl md:text-7xl lg:text-7xl 
                  ...
                  <div className="flex gap-[20px] items-center flex-wrap">
                    {e?.linkTo.length > 1 && (
                      <Link target="_blank" href={e.linkTo}>
                        <div
                          className="border border-[#F3F3F3] p-[12px] cursor-pointer text-white rounded-full font-bwmss01 font-light min-h-[55px] pt-[15px] min-w-[120px] text-center"
                          style={{
                            background:
                              "transparent linear-gradient(360deg, #13224F 0%, #13224F 0%, #0C1C46 51%, #020F3B 100%) 0% 0% no-repeat padding-box",
                          }}
